...
def turtle4():
    hh = rg.SimpleTurtle()
    hh.pen = rg.Pen('coral',10)

    hh.draw_circle(100)


def turtle5():
    lanxi = rg.SimpleTurtle('square')
    lanxi.pen = rg.Pen('gold',7)

    lanxi.draw_regular_polygon(5,50)

    mengyue = rg.SimpleTurtle('turtle')
    mengyue.pen = rg.Pen('khaki',9)

    mengyue.draw_square(100)
